package com.cso.iiq.request.controller;
...
public class ManageCustomController extends BasePluginResource {  
  
        private static final Logger logger = Logger.getLogger(ManageCustomController.class);  
  
        @Override  
        public String getPluginName() {  
                return "ManagePluginForm";  
        }  
